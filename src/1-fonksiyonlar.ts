...
const kardesPayi = (name = "senin") => {
  //video yayınlarda name: string böyle görmüştüm. string olduğunu neden belirtmedik?
  console.log(`Bir tane ${name} için, bir de benim için.`);
};

kardesPayi("Ayşe");
kardesPayi(); //burada undifined gelmişti o nasıl oluyor?
